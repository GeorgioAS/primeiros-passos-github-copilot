...
activities = {
   ...
   "Clube de Leitura": {
      ...
      "max_participants": 15,
      "participants": ["bruna@mergington.edu", "carlos@mergington.edu"]
   },
   "Olimpíada de Matemática": {
      "description": "Preparação para olimpíadas e desafios matemáticos",
      "schedule": "Sábados, 8h - 10h",
      "max_participants": 25,
      "participants": ["aline@mergington.edu", "rodrigo@mergington.edu"]
   }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    #Validar se o estudante já esta inscrito
